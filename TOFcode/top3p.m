...
for t = 1:num_steps
    ...
    TOF_estimates_1(:, t) = TOF_localization(anchors, noisy_tof_times);
end
...
for t = 1:num_steps
    ...
    measurement_noise = 0.1; % 噪声水平 (ns)
    noisy_tof_times = DS_TWR(measurement_noise, anchors, true_target);
    TOF_estimates_2(:, t) = TOF_localization(anchors, noisy_tof_times);
end
...
for t = 1:num_steps
    ...
    measurement_noise = 0.1; % 噪声水平 (ns)
    noisy_tof_times = DS_TWR(measurement_noise, anchors, true_target);
    TOF_estimates_3(:, t) = TOF_localization(anchors, noisy_tof_times);
end
